                        ...
                        <ul class="nav navbar-nav"> 
                            ...
                            <li class="dropdown notifications-menu">
                                <a href="{{URL::route('reports.index')}}" >
                                    ...
                                    <span class="label label-warning">{{App::make('Report')->ByUnRead()->count()}}</span>
                                </a> 
                            </li> 
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="{{URL::route('statues.create')}}"><i class="fa fa-circle-o"></i>新建</a></li>
                                <li><a href="{{URL::route('statues.index')}}"><i class="fa fa-circle-o"></i>列表</a></li> 
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="{{URL::route('users.create')}}"><i class="fa fa-circle-o"></i> 新建</a></li>
                                <li><a href="{{URL::route('users.index')}}"><i class="fa fa-circle-o"></i> 列表</a></li> 
                            </ul>
                        </li>
                        <li >
                            <a href="{{URL::route('reports.index')}}">
