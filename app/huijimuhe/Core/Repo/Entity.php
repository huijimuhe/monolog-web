<?php namespace huijimuhe\Core\Repo;

use Illuminate\Database\Eloquent\Model;
use Validator;
use huijimuhe\Core\Exceptions\NoValidationRulesFoundException;
use huijimuhe\Core\Exceptions\NoValidatorInstantiatedException;
